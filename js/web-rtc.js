    ...
    try {
        ...
        if (o.offer) {
            ...
            try {
                ...
                var answerKey = makePeerKeyword(worldName, userName);
                console.log("[WEBRTC] Successfully processed answer for:", e), addMessage("Connected to " + e + " via file", 5e3), updateHudButtons(), clearInterval(answerPollingIntervals.get(answerKey)), answerPollingIntervals.delete(answerKey)
            } catch (t) {
            ...
            try {
                ...
                var batchAnswerKey = makePeerKeyword(worldName, userName);
                console.log("[WEBRTC] Successfully processed batch answer for:", e), addMessage("Connected to " + e + " via batch file", 5e3), updateHudButtons(), clearInterval(answerPollingIntervals.get(batchAnswerKey)), answerPollingIntervals.delete(batchAnswerKey)
            } catch (t) {
