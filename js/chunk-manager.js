...
const RECIPES = [
    { out: { id: 105, count: 4 }, requires: { 3: 4 } }, // Brick from Dirt
    { out: { id: 100, count: 1 }, requires: { 5: 1 } }, // Glass from Sand
    { out: { id: 120, count: 4 }, requires: { 11: 1, 7: 1 } }, // Torches from Coal and Wood
    { out: { id: 121, count: 1 }, requires: { 111: 1, 11: 1, 106: 1 } }, // Laser Gun
];
